...
Item {
  ...
  Loader {
    property string updateCheckUrl: system.publishBuild ? "https://v-play.net/qml-sources/OnuVersionCheck.qml" : "https://v-play.net/qml-sources/OnuVersionCheck-test.qml"
