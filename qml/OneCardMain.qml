...
import VPlayPlugins 1.0 // for Push Notification support when you get a friend request or game invite, and for Facebook login to synch your data across multiple devices & platforms
...
// contact us via support@v-play.net if you want to enable push notifications & Facebook in your multiplayer games or in this demo
...
GameWindow {
  ...
  VPlayMultiplayer {
    ...
    // instead, use your own ones from http://gamenetwork.v-play.net/
